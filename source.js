...
var interestRate = .08;
var taxRate = .3;
var interestCompoundFrequency = 365;


var container = d3.select(".container")
  .style("background-color","lightgrey");

// create and animate clock widget

//create net worth bar at bottom (use a class to float inline-block divs at bottom)

// create and animate growing bars for incomes, taxes, expenses 
// should expenses be a % of earned income, or total income (including interest etc)
